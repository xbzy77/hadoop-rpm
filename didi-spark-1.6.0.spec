...
%define sparkpath  /usr/local/%{name}-%{version}
%description
...
/bin/ln -s /usr/local/%{name}-%{version}  /usr/local/spark-current
mkdir -pm 1777 /usr/local/spark/tmp
